...
<div class="main-header">
    ...
    <p>Tác giả: Hà Thị Nguyệt Oanh - Trường Tiểu học Nguyễn Trãi, xã Bắc Quang - ĐT: 0387 376 928</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 -  Hà Thị Nguyệt Oanh - Trường Tiểu học Nguyễn Trãi, xã Bắc Quang - ĐT: 0387 376 928</div>", unsafe_allow_html=True)
